  ...
  return (
    <ScrollView style={styles.container}>
      ...
      <View style={styles.categoryContainer}>
          ...
          <View>
            <View style={styles.categoryContent}>
              <View style={styles.categoryTextContainer}>
                <Text style={styles.categoryTitle}>Eye Exercises</Text>
        ...
        {/* Fourth Card */}
        <TouchableOpacity
          style={[styles.categoryCard, { backgroundColor: "#35f375" }]}
          onPress={() => navigation.navigate("Check Eye Blindness")}
        >
          <View>
            <View style={styles.categoryContent}>
              <View style={styles.categoryTextContainer}>
                <Text style={styles.categoryTitle}>Predict Blindness</Text>
                <Text style={styles.categoryDescription}>
                  Lorem ipsum dolor sit amet, consectetur adipiscing elit.
                </Text>
                <TouchableOpacity style={styles.learnMoreButton}>
        ...
        >
          <View>
            <View style={styles.categoryContent}>
              <View style={styles.categoryTextContainer}>
                <Text style={styles.categoryTitle}>Predict Diabatic</Text>
                <Text style={styles.categoryDescription}>
                  Lorem ipsum dolor sit amet, consectetur adipiscing elit.
                </Text>
                <TouchableOpacity style={styles.learnMoreButton}>
